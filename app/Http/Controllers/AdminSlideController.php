...
class AdminSlideController extends Controller
{
    ...
    function postAdd(Request $request)
    {
    	$this->validate($request, [
            ...
            'tab' => 'required|numeric|min:0|max:1',
    	], 
    	[
            ...
            'tab.required' => "Bạn chưa chọn trạng thái.",
            'tab.numeric' => "Chọn sai trạng thái.",
            'tab.min' => "Chọn sai trạng thái.",
            'tab.max' => "Chọn sai trạng thái.",
    	]);
