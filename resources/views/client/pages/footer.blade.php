<footer id="footer">
  ...
  <hr>
    ...
    <p class="copyright" id="cypright"> Copyright © 2019 <a href="">Quận Đoàn Ngũ Hành Sơn</a></p>

    <script>
        let cypright = new Date();
        cypright = cypright.getFullYear();
        document.getElementById("cypright").innerHTML = "Copyright © " + cypright;
    </script>
