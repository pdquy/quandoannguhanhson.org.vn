            ...
            <div class="col-lg-12">
                ...
                <form action="{{ route('postAddSlide') }}" method="POST" enctype="multipart/form-data">
		            ...
		            <div class="form-group">
		                ...
		                <label style="display:block;">Mở theo Tab</label>

		                <label class="radio-inline"><input checked="checked" type="radio" name="tab" value="1">Tab hiện tại</label>

		                <label class="radio-inline"><input type="radio" name="tab" value="0">Tab mới</label>
