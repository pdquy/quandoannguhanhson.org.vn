           ...
           @foreach ($list as $index => $element)
               ...
               <tr class="odd gradeX" align="center">
                    <form action="{{ route('postEditPost', ['id'=>$element->id]) }}" method="POST">
                        ...
                        <td><button type="button" onclick="alert('Chức năng đang được phát triển. Mời bạn chọn chỉnh sửa!')" class="btn btn-success" disabled id="{{ $element->id }}">LƯU</button></td>
                    </form>
                </tr>
           @endforeach
